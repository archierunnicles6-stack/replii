#!/bin/bash
# Double-click this file to build a signed + notarized Replii.dmg.
...
echo "Building Replii… (passwords stay on this Mac only)"
echo ""
...
echo ""
echo "Done. If successful, open: $(pwd)/release/Replii.dmg"
read -r -p "Press Enter to close…"
