...
export const termsSections: LegalSection[] = [
  ...
  },
  {
    ...
    content: (
      <>
        <LegalP>
          {LEGAL.productName} is a real-time AI-assisted sales coaching tool
          that may, depending on your settings and device permissions:
        </LegalP>
        <LegalUl>
          <LegalLi>
            Capture and transcribe audio from your microphone and, where
            permitted, system audio from your device;
          </LegalLi>
          <LegalLi>
            Display coaching suggestions, prompts, summaries, and related
            outputs through an on-screen overlay;
          </LegalLi>
          <LegalLi>
            Process conversation content using third-party artificial
            intelligence services to generate suggestions;
          </LegalLi>
          <LegalLi>
            Store meeting transcripts, summaries, settings, and related data
    ...
    content: (
      <>
        <LegalP>
          ...
          microphone, screen capture, and related OS-level access. You are
        ...
        <LegalP>
          ...
          complies with the policies of your employer, customers, prospects,
          regulators, and any platform you use during calls or meetings.
        </LegalP>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <LegalP>
          We make no warranty that AI outputs will improve sales performance,
          close rates, compliance, or any business outcome.
        </LegalP>
      </>
    ),
  },
    ...
    content: (
      <>
        <LegalP>
          ...
          displayed by the Service, including coaching suggestions visible on
    ...
    content: (
      <>
        ...
        <LegalUl>
          ...
          <LegalLi>
            Disputes with customers, employers, prospects, or call
