...
const columns = [
  {
    ...
    description:
      "Surface the right response the moment your prospect finishes speaking — not in a post-call recap.",
    icon: BoltIcon,
  },
  {
    title: "Call review",
    description:
      "Every session is logged with transcripts and deal scores — so managers can coach reps on what worked.",
    icon: ChartIcon,
  },
  {
  ...
  },
  {
    title: "Call insights",
    description:
      "Review transcripts, suggestions used, and key moments after every call to improve faster.",
    icon: ChartIcon,
  },
];
